...
const (
	...
	RELEASE_URL                      string = "https://github.com/DreamPhreak/discord-image-downloader-go/releases"
	RELEASE_API_URL                  string = "https://api.github.com/repos/DreamPhreak/discord-image-downloader-go/releases/latest"
...
func main() {
	...
	if (!cfg.Section("auth").HasKey("email") ||
		...
		cfg.Section("auth").NewKey("token", "your account token")
